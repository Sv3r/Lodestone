...
public class LodestoneShaders {
    ...
    public static ShaderHolder DISTORTED_TEXTURE = new ShaderHolder(
            "Speed",
            "TimeOffset",
            "Intensity",
            "XFrequency",
    ...
    public static ShaderHolder RADIAL_NOISE = new ShaderHolder(
            "Speed",
            "XFrequency",
            "YFrequency",
            "Intensity",
    ...
    public static ShaderHolder RADIAL_SCATTER_NOISE = new ShaderHolder(
            "Speed",
            "XFrequency",
            "YFrequency",
            "Intensity",
    ...
    public static void init(ResourceFactory manager) throws IOException {
        ...
        registerShader(ExtendedShaderProgram.createShaderProgram(
                LODESTONE_TEXTURE,
                manager,
                LodestoneLib.id("lodestone_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                PARTICLE,
                manager,
                LodestoneLib.id("particle"),
                VertexFormats.POSITION_TEXTURE_COLOR_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                SCREEN_PARTICLE,
                manager,
                LodestoneLib.id("screen_particle"),
        ...
        registerShader(ExtendedShaderProgram.createShaderProgram(
                MASKED_TEXTURE,
                manager,
                LodestoneLib.id("masked_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                DISTORTED_TEXTURE,
                manager,
                LodestoneLib.id("noise/distorted_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                METALLIC_NOISE,
                manager,
                LodestoneLib.id("noise/metallic"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                RADIAL_NOISE,
                manager,
                LodestoneLib.id("noise/radial_noise"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                RADIAL_SCATTER_NOISE,
                manager,
                LodestoneLib.id("noise/radial_scatter_noise"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        ...
        registerShader(ExtendedShaderProgram.createShaderProgram(
                SCROLLING_TEXTURE,
                manager,
                LodestoneLib.id("vfx/scrolling_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                TRIANGLE_TEXTURE,
                manager,
                LodestoneLib.id("vfx/triangle_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                COLOR_GRADIENT_TEXTURE,
                manager,
                LodestoneLib.id("vfx/color_gradient_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
        registerShader(ExtendedShaderProgram.createShaderProgram(
                SCROLLING_TRIANGLE_TEXTURE,
                manager,
                LodestoneLib.id("vfx/scrolling_triangle_texture"),
                VertexFormats.POSITION_COLOR_TEXTURE_LIGHT
        ));
    }
    ...
    public static void registerShader(ExtendedShaderProgram extendedShaderProgramInstance) {
        registerShader(
                extendedShaderProgramInstance,
                (shader) -> ((ExtendedShaderProgram) shader).getHolder().setInstance((ExtendedShaderProgram) shader)
        );
    }
