...
import team.lodestar.lodestone.mixin.accessor.RenderLayer$MultiPhaseAccessor;
import team.lodestar.lodestone.mixin.accessor.RenderLayer$MultiPhaseParametersAccessor;
import team.lodestar.lodestone.mixin.accessor.RenderPhaseAccessor;
...
public class LodestoneRenderLayers extends RenderPhase {
    ...
    public static final RenderLayer ADDITIVE_PARTICLE = createGenericRenderLayer(
            ...
            LodestoneShaders.PARTICLE.phase,
    ...
    public static final RenderLayer ADDITIVE_BLOCK = createGenericRenderLayer(
            ...
            VertexFormat.DrawMode.QUADS,
            LodestoneShaders.LODESTONE_TEXTURE.phase,
            Phases.ADDITIVE_TRANSPARENCY,
    ...
    public static final RenderLayer LUMITRANSPARENT_PARTICLE = copyWithUniformChanges(
            "lumitransparent_particle",
            TRANSPARENT_PARTICLE,
            ShaderUniformHandler.LUMITRANSPARENT
    );
    public static final RenderLayer LUMITRANSPARENT_BLOCK = copyWithUniformChanges(
            "lumitransparent_block",
            TRANSPARENT_BLOCK,
            ShaderUniformHandler.LUMITRANSPARENT
    );
    public static final RenderLayer LUMITRANSPARENT_SOLID = copyWithUniformChanges(
    ...
    public static final RenderLayerProvider TEXTURE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
            "texture",
            POSITION_COLOR_TEXTURE_LIGHT,
            VertexFormat.DrawMode.QUADS,
            LodestoneShaders.LODESTONE_TEXTURE.phase,
            Phases.NO_TRANSPARENCY,
            texture
    ));
    public static final RenderLayerProvider TRANSPARENT_TEXTURE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
            "transparent_texture",
            POSITION_COLOR_TEXTURE_LIGHT,
            VertexFormat.DrawMode.QUADS,
    ...
    public static final RenderLayerProvider TRANSPARENT_TEXTURE_TRIANGLE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
    ...
    public static final RenderLayerProvider ADDITIVE_TEXTURE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
            "additive_texture",
            POSITION_COLOR_TEXTURE_LIGHT,
            VertexFormat.DrawMode.QUADS,
    ...
    public static final RenderLayerProvider ADDITIVE_TEXTURE_TRIANGLE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
    ...
    public static final RenderLayerProvider RADIAL_NOISE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
            "radial_noise",
            POSITION_COLOR_TEXTURE_LIGHT,
            VertexFormat.DrawMode.QUADS,
    ...
    public static final RenderLayerProvider RADIAL_SCATTER_NOISE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
    ...
    public static final RenderLayerProvider SCROLLING_TEXTURE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
            "scrolling_texture",
            POSITION_COLOR_TEXTURE_LIGHT,
            VertexFormat.DrawMode.QUADS,
    ...
    public static final RenderLayerProvider SCROLLING_TEXTURE_TRIANGLE = new RenderLayerProvider((texture) -> createGenericRenderLayer(
            texture.getNamespace(),
    ...
    public static RenderLayer createGenericRenderLayer(String modId, String name, VertexFormat format, VertexFormat.DrawMode mode, ShaderProgram shader, Transparency transparency, Identifier texture) {
        return createGenericRenderLayer(
                modId + ":" + name,
                format,
                mode,
                shader,
                transparency,
                new Texture(texture, false, false)
        );
    }
    ...
    public static RenderLayer createGenericRenderLayer(String name, VertexFormat format, VertexFormat.DrawMode mode, RenderLayer.MultiPhaseParameters.Builder builder) {
        RenderLayer type = RenderLayer.of(
                ...
                format,
                mode,
                LodestoneLibClient.CLIENT_LOADER_INSTANCE.isModLoaded("sodium") ? 262144 : 256,
                false,
                false,
                builder.build(true)
        );
     ...
     * Prior to ending a batch, we run {@link ShaderUniformHandler#updateShaderData(net.minecraft.client.gl.ShaderProgram)} if one is present for a given render type.
     */
    ...
    public static class RenderLayerData {
        ...
        public RenderLayerData(RenderLayer.MultiPhase type) {
            this(
                    ((RenderPhaseAccessor) (Object) type).getName(),
                    type.getVertexFormat(),
                    type.getDrawMode(),
                    ((RenderLayer$MultiPhaseParametersAccessor) (Object) ((RenderLayer$MultiPhaseAccessor) (Object) type).getPhases()).getProgram(),
                    ((RenderLayer$MultiPhaseParametersAccessor) (Object) ((RenderLayer$MultiPhaseAccessor) (Object) type).getPhases()).getTransparency(),
                    ((RenderLayer$MultiPhaseParametersAccessor) (Object) ((RenderLayer$MultiPhaseAccessor) (Object) type).getPhases()).getTexture()
