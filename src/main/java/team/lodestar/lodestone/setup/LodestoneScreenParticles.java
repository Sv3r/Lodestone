...
import team.lodestar.lodestone.mixin.accessor.FabricSpriteProviderImplAccessor;
import team.lodestar.lodestone.mixin.accessor.ParticleManagerAccessor;
...
public class LodestoneScreenParticles {
    ...
    public static SpriteProvider getSpriteSet(Identifier resourceLocation) {
        ...
        return FabricSpriteProviderImplAccessor.callInit(
                client.particleManager,
                ((ParticleManagerAccessor) client.particleManager).getSpriteAwareFactories().get(resourceLocation)
        );
    }
