    ...
    public void spawnParticles(HashMap<LodestoneScreenParticleTextureSheet, ArrayList<ScreenParticle>> target, World world, float tickDelta, ItemStack stack, float x, float y) {
        ...
        ScreenParticleBuilder.create(LodestoneScreenParticles.STAR, target)
                             .setColorData(ColorParticleData
                                     ...
                                     .build())
                             .setLifetime(8)
                             .setTransparencyData(GenericParticleData.create(0.2f, 0)
                                                                     .setEasing(Easing.QUINTIC_IN)
                                                                     .build())
                             .setScaleData(GenericParticleData.create(
                                     (float) (0.75f + Math.sin(gameTime * 0.05f) * 0.15f),
                                     0
                             ).build())
                             .setRandomOffset(0.05f)
                             .setSpinData(SpinParticleData.create(0, 1)
                             ...
                             .setColorData(ColorParticleData
                                     ...
                                     .build())
                             .setScaleData(GenericParticleData.create(
                                     (float) (0.75f - Math.sin(gameTime * 0.075f) * 0.15f),
                                     0
                             ).build())
                             .setSpinData(SpinParticleData.create(0, 1)
                             ...
                             .spawnOnStack(0, 0)
                             .setScaleData(GenericParticleData.create(
                                     (float) (0.9f - Math.sin(gameTime * 0.1f) * 0.175f),
                                     0
                             ).build())
                             .setSpinData(SpinParticleData.create(0, 1)
